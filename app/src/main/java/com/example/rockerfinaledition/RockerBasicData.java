...
public class RockerBasicData extends View {
    private static final String TAG = "RockerBasicData";
    ...
    public RockerBasicData(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initAttribute(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.RockerBasicData);

        // 可移动区域背景
        Drawable areaBackground = typedArray.getDrawable(R.styleable.RockerBasicData_areaBackground);
        ...
        // 摇杆背景
        Drawable rockerBackground = typedArray.getDrawable(R.styleable.RockerBasicData_rockerBackground);
        ...
        // 摇杆半径
        mRockerRadius = typedArray.getDimensionPixelOffset(R.styleable.RockerBasicData_rockerRadius, DEFAULT_ROCKER_RADIUS);
